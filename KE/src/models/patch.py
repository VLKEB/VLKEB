...
def _make_functional(
    ...
    def patched_forward(self, *args, params=None, **kwargs):
        # print(self._param_names, self.__class__.__name__, self.root is None, id(self.root))
...
def make_functional(
    ...
    def _patched_forward(self, *args, params=None, **kwargs):
        # print("_patched_forward", self._param_names, self.__class__.__name__, self.root is None)
...
def monkeypatch(
    ...
    # print('fmodule id', fmodule.__class__.__name__, id(fmodule))
